...
//!
//! - `lookup_upper_alias` — `phf::Map`-backed lookup for ftfy's ALL-CAPS
//!   HTML entity aliases (`&EACUTE;` → `É`), derived from `htmlize::ENTITIES`.
//!   Replaces a ~500 µs lazy_static FxHashMap init.
